...
/*
  Create a while-loop that logs "Your score is not high enough" while the score variable above is below passingScore.
   In each iteration of the loop, increase the score by one. If your code is successful, you will see your logged statement 
   7 times.
*/
...
//   changeMyMind = false;
//   console.log(`Change my mind is false.`)
// }else{
//   changeMyMind = true;
